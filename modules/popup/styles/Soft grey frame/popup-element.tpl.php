...
<?php if ($body) {
  print $body['prefix']; ?>
    ...
    <div id="<?php print $id; ?>-body" class="<?php print $classes['body']; ?>">
      ...
      <div class="<?php print $classes['body-wrapper']; ?> popup-body-edge popup-body-t">
        <div class="<?php print $classes['body-wrapper']; ?> popup-body-edge popup-body-tl"></div>
        <div class="<?php print $classes['body-wrapper']; ?> popup-body-edge popup-body-tr"></div>
      </div>
      ...
      <div class="<?php print $classes['body-wrapper']; ?> popup-body-edge popup-body-b">
        <div class="<?php print $classes['body-wrapper']; ?> popup-body-edge popup-body-bl"></div>
        <div class="<?php print $classes['body-wrapper']; ?> popup-body-edge popup-body-br"></div>
      </div>
