 ...
 */
 $type_string = '';
  switch($row->node_type) {
		case 'discussion':
			$type_string = 'created a new <strong>discussion topic</strong>';
			break;
		case 'document':
			$type_string = 'created a new <strong>document</strong>';
			break;	
		case 'submission':
			$type_string = 'submitted an <strong>assignment</strong>';
			break;
		default:
			$type_string = 'created a new <strong>' . $output . '</strong>';
		break;
	}
?>
